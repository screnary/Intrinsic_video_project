...
opt.continue_train = False                  # !check if there are pretrained # The flag to determine whether to continue training
...
opt.data.num_workers = 16                           # number of data loading threads
...
opt.data.image_height = 320
opt.data.image_width = 320
...
opt.data.data_root = '/home/wzj/ws/intrinsic/data/'        # dataset folder location
...
opt.optim.weight_decay = 1e-4               # weight decay: 0.0001,[1e-6]
...
# video flow loss
opt.optim.flow_idt_w = 50.0
opt.optim.lambda_flow_r = 10.0
opt.optim.lambda_flow_s = 5.0
