...
root_source = '../datasets/MPI/refined_gs/MPI-main-shading/';

root_input = '../datasets/MPI/refined_gs/MPI-main-input-300';
root_albedo = '../datasets/MPI/refined_gs/MPI-main-albedo-300';
root_shading = '../datasets/MPI/refined_gs/MPI-main-shading-300';
root_mask = '../datasets/MPI/refined_gs/MPI-main-mask-300';
...
parfor m = 1:length(firstList)
    ...
    while count < 10
        ...
        if sum(maskNum(:)) > 0.05 * patch_dim * patch_dim  % 0.05
            continue;
        end
